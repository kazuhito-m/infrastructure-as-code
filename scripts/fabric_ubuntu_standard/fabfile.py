...
def install_text_editors():
	...
	# plugin設定
	run("apm install plantuml-viewer language-plantuml japanese-menu markdown-scroll-sync atom-beautify auto-encoding") # http://pierre3.hatenablog.com/entry/2015/08/23/220217
...
def install_communication_tools():
	run("wget -O /tmp/slack-desktop.deb https://downloads.slack-edge.com/linux_releases/slack-desktop-2.4.2-amd64.deb")
